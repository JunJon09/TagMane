            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        <h1 class="mt-4">発行画面</h1>
                        <ol class="breadcrumb mb-4">
                            <li class="breadcrumb-item active">htmlタグに挿入するタグ</li>
                        </ol>
                           
                        <div class="card mb-4">
                            <div class="tag">
                                <div class="sample-box-1" id="copy_tag">&lt;script src="http://localhost/tag/{{$TR_count}}"&gt;&lt;/script&gt;</div>
